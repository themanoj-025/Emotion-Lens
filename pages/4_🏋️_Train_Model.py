...
def _run_training(dataset_source, local_path, arch_type, epochs, batch_size,
    ...
    try:
        ...
        with step_col1:
            st.page_link("pages/1_🎥_Live_Camera.py", label="🎥 Test with Live Camera", icon="🎥")
        with step_col2:
            st.page_link("pages/2_🖼️_Image_Analysis.py", label="🖼️ Try Image Analysis", icon="🖼️")
        with step_col3:
            st.page_link("pages/5_🧠_Model_Inspector.py", label="🧠 Inspect Model", icon="🧠")
