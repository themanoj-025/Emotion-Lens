...
def _render_gradcam_tab(model):
    ...
    from utils.model_utils import predict_emotion as _predict
    # Use grayscale face ROI directly
    result = _predict(model, img_resized)
    emotion, confidence, probs = result['emotion'], result['confidence'], result['probabilities']
